  ...
  return (
    <div className="overflow-x-hidden">
      <div className="min-h-screen bg-white  mx-auto">
        ...
        <div className="my-[60px] lg:my-[100px] mx-4 max-w-[2048px] lg:mx-auto">
          <TextImageSection
            title="О гостиничном <br>комплексе"
            text="Гостиничный комплекс «Premium», расположен в тихом и уютном месте самого сердца г. Щелково, на берегу реки Клязьма. У нас вы найдете свой тихий уголок, вдали от шумных улиц, где сможете прекрасно провести время, будучи в деловой поездке или устраивая романтичный вечер при свечах." image="/assets/images/home/1.jpg" button={{ text: 'Текущие акции', link: '/promotions' }}
            reverse={true} />
        </div>
